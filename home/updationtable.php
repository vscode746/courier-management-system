    ...
    <form action="editdata.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid"
                style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:#b8d2e3; width: 140px; height: 50px;">Update
                    The Details As Required</th>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="4" align="center"><input type="submit" name="submit" value="Update"
